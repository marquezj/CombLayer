...
#declare cameraNumber = 4; // 0: DTL global view;  1: beam dump view;  2: PMQ view; 3: FEB+tunnel view; 4: TSW view
...
#break
#case(4) // TSW
 #declare cameraLocation = <0, 4000, 15>;
 #declare cameraLookAt   = <0, 4850 0>;
